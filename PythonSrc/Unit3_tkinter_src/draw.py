...
# Python jumps right here after executing def main(). These two lines tell 
# Python to jump to the first line of the main function above.
# Seems a little strange, but there are good reasons for this,
# which you'll learn if you take some computer science.
